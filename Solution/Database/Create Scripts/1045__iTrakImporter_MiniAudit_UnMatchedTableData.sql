...
CREATE TABLE [dbo].[__iTrakImporter_MiniAudit_UnMatchedTableData] (
...
ALTER TABLE [dbo].[__iTrakImporter_MiniAudit_UnMatchedTableData] ADD 
	CONSTRAINT [PK___iTrakImporter_MiniAudit_UnMatchedTableData] PRIMARY KEY  CLUSTERED 
	(
		[RowID]
	)  ON [PRIMARY] 
GO
