...
CREATE TABLE [dbo].[__iTrakImporter_DetailedReport_UnMatchedTableData] (
...
ALTER TABLE [dbo].[__iTrakImporter_DetailedReport_UnMatchedTableData] ADD 
	CONSTRAINT [PK___iTrakImporter_DetailedReport_UnMatchedTableData] PRIMARY KEY  CLUSTERED 
	(
		[RowID]
	)  ON [PRIMARY] 
GO
