...
namespace iTrak.Importer.Data
{
    ...
    public static class SqlClientUtility
    {
        ...
        /// <summary>
        /// Executes the stored procedure with the specified parameters and returns the result as a <see cref="IDataReader"/>.
        /// </summary>
        /// <param name="connectionStringName">The name of the connection string to use.</param>
        /// <param name="commandType">The command type.</param>
        /// <param name="commandText">The stored procedure to execute.</param>
        /// <param name="parameters">The parameters of the stored procedure.</param>
        /// <returns>A <see cref="IDataReader"/> containing the results of the stored procedure execution.</returns>
        public static IDataReader ExecuteReader(string connectionStringName, CommandType commandType, string commandText, params SqlParameter[] parameters)
        {
            if (Transaction.Current == null)
            {
                string connectionString = ConfigurationManager.ConnectionStrings[connectionStringName].ConnectionString;
        ...
        /// <summary>
        /// Attempts to extract the requested column value from a IDataReader.
        /// </summary>
        /// <param name="dataReader">The IDataReader to extract the column value from.</param>
        /// <param name="columnName">The name of the column to extract the value from.</param>
        /// <param name="valueIfNull">The value to return if the requested column value is null or DBNull.Value.</param>
        /// <returns>The value contained in the requested column if the value is not null or DBNull.Value, otherwise null.</returns>
        public static bool GetBoolean(IDataReader dataReader, string columnName, bool valueIfNull)
        {
        ...
        /// <param name="valueIfNull">The value to return if the requested column value is null or DBNull.Value.</param>
        /// <returns>The value contained in the requested column if the value is not null or DBNull.Value, otherwise the value specified by <code>valueIfNull</code>.</returns>
        public static byte GetByte(IDataReader dataReader, string columnName, byte valueIfNull)
        {
        ...
        /// <param name="valueIfNull">The value to return if the requested column value is null or DBNull.Value.</param>
        /// <returns>The value contained in the requested column if the value is not null or DBNull.Value, otherwise the value specified by <code>valueIfNull</code>.</returns>
        public static byte[] GetBytes(IDataReader dataReader, string columnName, byte[] valueIfNull)
        {
            object value = GetObject(dataReader, columnName, null);
            if (value != null && value is byte[])
            {
        ...
        /// <param name="valueIfNull">The value to return if the requested column value is null or DBNull.Value.</param>
        /// <returns>The value contained in the requested column if the value is not null or DBNull.Value, otherwise null.</returns>
        public static DateTime GetDateTime(IDataReader dataReader, string columnName, DateTime valueIfNull)
        {
            object value = GetObject(dataReader, columnName, null);
            if (value != null)
            {
        ...
        /// <param name="valueIfNull">The value to return if the requested column value is null or DBNull.Value.</param>
        /// <returns>The value contained in the requested column if the value is not null or DBNull.Value, otherwise null.</returns>
        public static decimal GetDecimal(IDataReader dataReader, string columnName, decimal valueIfNull)
        {
            object value = GetObject(dataReader, columnName, null);
            if (value != null)
            {
        ...
        /// <param name="valueIfNull">The value to return if the requested column value is null or DBNull.Value.</param>
        /// <returns>The value contained in the requested column if the value is not null or DBNull.Value, otherwise null.</returns>
        public static double GetDouble(IDataReader dataReader, string columnName, double valueIfNull)
        {
            object value = GetObject(dataReader, columnName, null);
            if (value != null)
            {
        ...
        /// <param name="valueIfNull">The value to return if the requested column value is null or DBNull.Value.</param>
        /// <returns>The value contained in the requested column if the value is not null or DBNull.Value, otherwise null.</returns>
        public static Guid GetGuid(IDataReader dataReader, string columnName, Guid valueIfNull)
        {
            object value = GetObject(dataReader, columnName, null);
            if (value != null)
            {
        ...
        /// <param name="valueIfNull">The value to return if the requested column value is null or DBNull.Value.</param>
        /// <returns>The value contained in the requested column if the value is not null or DBNull.Value, otherwise null.</returns>
        public static float GetSingle(IDataReader dataReader, string columnName, float valueIfNull)
        {
            object value = GetObject(dataReader, columnName, null);
            if (value != null)
            {
        ...
        /// <param name="valueIfNull">The value to return if the requested column value is null or DBNull.Value.</param>
        /// <returns>The value contained in the requested column if the value is not null or DBNull.Value, otherwise null.</returns>
        public static short GetInt16(IDataReader dataReader, string columnName, short valueIfNull)
        {
            object value = GetObject(dataReader, columnName, null);
            if (value != null)
            {
        ...
        /// <param name="valueIfNull">The value to return if the requested column value is null or DBNull.Value.</param>
        /// <returns>The value contained in the requested column if the value is not null or DBNull.Value, otherwise null.</returns>
        public static int GetInt32(IDataReader dataReader, string columnName, int valueIfNull)
        {
            object value = GetObject(dataReader, columnName, null);
            if (value != null)
            {
        ...
        /// <param name="valueIfNull">The value to return if the requested column value is null or DBNull.Value.</param>
        /// <returns>The value contained in the requested column if the value is not null or DBNull.Value, otherwise null.</returns>
        public static long GetInt64(IDataReader dataReader, string columnName, long valueIfNull)
        {
            object value = GetObject(dataReader, columnName, null);
            if (value != null)
            {
        ...
        /// <param name="valueIfNull">The value to return if the requested column value is null or DBNull.Value.</param>
        /// <returns>The value contained in the requested column if the value is not null or DBNull.Value, otherwise null.</returns>
        public static object GetObject(IDataReader dataReader, string columnName, object valueIfNull)
        {
        ...
        /// <param name="valueIfNull">The value to return if the requested column value is null or DBNull.Value.</param>
        /// <returns>The value contained in the requested column if the value is not null or DBNull.Value, otherwise null.</returns>
        public static string GetString(IDataReader dataReader, string columnName, string valueIfNull)
        {
            object value = GetObject(dataReader, columnName, null);
            if (value != null)
            {
